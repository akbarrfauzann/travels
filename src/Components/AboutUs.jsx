    ...
    <section data-aos="fade-up">
      <div className="container mx-auto py-2 px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-xl overflow-hidden mb-16">
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url("/src/assets/images/banda2.jpg")` }}></div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          ...
          <div className="lg:w-1/2">
            <img src="/src/assets/images/swiss2.jpg" alt="Swiss landscape" className="rounded-xl shadow-lg" />
          </div>
        </div>
