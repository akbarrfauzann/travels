...
export default function BlogDetail() {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12" data-aos="fade-up">
      ...
      <div className="mb-10">
        <img src="/src/assets/images/swiss1.jpg" alt="Swiss landscape" className="w-full h-auto object-cover rounded-lg shadow-lg" loading="lazy" />
      ...
      <div className="mt-12 bg-blue-100 p-6 rounded-lg">
        ...
        <div className="flex items-center">
          <img src="/src/assets/images/swiss1.jpg" alt="John Doe" className="w-24 h-24 rounded-full mr-4" />
          <div>
