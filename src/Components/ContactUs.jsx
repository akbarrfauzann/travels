      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 flex flex-col justify-center relative bg-cover bg-center p-6 rounded-3xl shadow-md overflow-hidden h-64 sm:h-auto" style={{ backgroundImage: 'url("/src/assets/images/swiss1.webp")' }}>
